...
- 핵심 개념: if/elif/else, 비교·논리 연산자, for/while, range, break
- 실습: **AI 부트캠프 장학 기준 판정기**
- 산출물: **여러 조건과 반복을 적용한 판정 프로그램**
...
[이번 주 Colab 열기](https://colab.research.google.com/github/MNU-AI-Programming/AI-Assisted-Python-Programming/blob/main/weeks/week03/practice.ipynb)
...
![조건과 반복으로 프로그램 흐름 제어](../../assets/diagrams/week03-flow.svg)
